...
class TaskAdapter(
    ...
    val dataActionDelegate: TaskViewContract
    ...
    inner class TaskViewHolder(view: View) : BaseViewHolder<Task>(view) {
        ...
        override fun onBind(data: Task, listIndex: Int) {
            (view as TaskView).initView(data,{ todoIndex, isCompleted ->
                dataActionDelegate.onTodoUpdate(listIndex, todoIndex, isCompleted)
            },{
